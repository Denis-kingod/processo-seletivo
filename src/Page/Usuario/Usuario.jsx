    ...
    render() {
        return (
            <div>
                <main>
                    <section>
                        <h1 className="Title">Bem vindo ao Pesquisador de Usuario do GitHub, insira o nome de usuário</h1>
                        <form onSubmit={this.buscarUsuario} className="formulario">
                            ...
                            <button className="btnp" type="submit" disable={this.state.nomeUsuario === '' ? 'none' : ''}>Procurar</button>
                        </form>
                    </section>
